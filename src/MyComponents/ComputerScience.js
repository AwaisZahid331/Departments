  ...
  return (
    <>
      <div className="heading" >
        <h3> Welcome to the <strong style={{ color: "yellow" }}>Computer Science</strong> . Our curriculum is divided into 8 semesters. You can download the course data and syllabus for each semester below:</h3>
          ...
          <div className="table-container">
            <div className="scrollable-table">
              <table className="animated-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  <tr style={{ borderBottom: '1px solid #ddd' }}>
                    <td style={{ padding: '8px' }}>{highlightText('Programming Fundamental 2023', 0)}Programming Fandamental 2023</td>
                    <td style={{ padding: '8px' }}>
                      <button onClick={() => downloadPdf('ch2.pdf')} style={{ padding: '5px 10px', border: 'none', cursor: 'pointer' }}>
                        Download PDF 
                      </button>
                  ...
                  <tr style={{ borderBottom: '1px solid #ddd' }}>
                    <td style={{ padding: '8px' }}>{highlightText('Programming Fundamental 2023', 0)}Calculas 2023</td>
                    <td style={{ padding: '8px' }}>
                      <button onClick={() => downloadPdf('ch2.pdf')} style={{ padding: '5px 10px', border: 'none', cursor: 'pointer' }}>
                        Download PDF 
                      </button>
                  ...
                  <tr style={{ borderBottom: '1px solid #ddd' }}>
                    <td style={{ padding: '8px' }}>{highlightText('Programming Fundamental 2023', 0)} Islamic Studies 2022</td>
                    <td style={{ padding: '8px' }}>
                      <button onClick={() => downloadPdf('ch2.pdf')} style={{ padding: '5px 10px', border: 'none', cursor: 'pointer' }}>
                        Download PDF 
                      </button>
                  ...
                  <tr style={{ borderBottom: '1px solid #ddd' }}>
                    <td style={{ padding: '8px' }}>{highlightText('Programming Fundamental 2023', 0)}Functional English 2021</td>
                    <td style={{ padding: '8px' }}>
                      <button onClick={() => downloadPdf('Chapter 2.pdf')} style={{ padding: '5px 10px', border: 'none', cursor: 'pointer' }}>
                        Download PDF 
                      </button>
                  ...
                  <tr style={{ borderBottom: '1px solid #ddd' }}>
                    <td style={{ padding: '8px' }}>{highlightText('Programming Fundamental 2023', 0)}2020</td>
                    <td style={{ padding: '8px' }}>
                      <button onClick={() => downloadPdf('Chapter 3.pdf')} style={{ padding: '5px 10px', border: 'none', cursor: 'pointer' }}>
                        Download PDF 
                      </button>
                  ...
                  <tr style={{ borderBottom: '1px solid #ddd' }}>
                    <td style={{ padding: '1px' }}>{highlightText('Programming Fundamental 2023', 0)}Information Communication Technology 2019</td>
