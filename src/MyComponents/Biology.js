    ...
    return (
        <>
            <div className="heading" >
                <h3> Welcome to the <strong style={{ color: "yellow" }}>Biology Department</strong> . Our curriculum is divided into 8 semesters. You can download the course data and syllabus for each semester below:</h3>
